...
const Index = forwardRef<
  HTMLDivElement,
  {
    ...
    setFunctionInfo: Function;
    functionSequence: { [key: string]: string };
  }
>(
  (
    {
    ...
    return (
      <div className="flex items-end gap-6">
        {index === 0 && (
          <div className="w-32 relative mb-2 ">
            <div className="bg-[#E29A2D] rounded-full h-5 flex text-white w-wi-31 m-auto mb-1">
              <span className="text-xs font-semibold m-auto leading-4 ">
                Initial value of x
              </span>
            </div>
            <input
        ...
        >
          ...
          <div className="w-64">
            ...
            <div className="py-4 px-7 w-56 pt-7">
              {/* Dot with border and space */}
              <div className="flex  justify-between">
                <div className="w-3 flex items-center">
                  <div className="dot-container input">
                    <div className="dot"></div>
                  </div>
                  <span className="ml-1">Input</span>
                </div>
        ...
        {index === 2 && (
          <div className="w-32 mb-2 relative">
